var $jscomp = $jscomp || {}
;($jscomp.scope = {}),
  ($jscomp.findInternal = function (t, e, a) {
    t instanceof String && (t = String(t))
    for (var n = t.length, o = 0; o < n; o++) {
      var s = t[o]
      if (e.call(a, s, o, t)) return { i: o, v: s }
    }
    return { i: -1, v: void 0 }
  }),
  ($jscomp.ASSUME_ES5 = !1),
  ...
  ($jscomp.polyfill = function (t, e, a, n) {
    if (e) {
      for (a = $jscomp.global, t = t.split('.'), n = 0; n < t.length - 1; n++) {
        var o = t[n]
        o in a || (a[o] = {}), (a = a[o])
      }
      ;(e = e((n = a[(t = t[t.length - 1])]))) != n &&
        null != e &&
    ...
    function (t) {
      var e = function (e, a, n) {
        var o = {
          ...
          getCaret: function () {
            try {
              ...
              if (n && -1 === navigator.appVersion.indexOf('MSIE 10')) {
                var r = n.createRange()
                r.moveStart('character', -o.val().length), (t = r.text.length)
              } else (s || '0' === s) && (t = s)
              return t
            } catch (t) {}
          },
          ...
          events: function () {
            e.on('keydown.mask', function (t) {
              ...
              .on('blur.mask', function () {
                i === o.val() || e.data('changed') || e.trigger('change'),
                  e.data('changed', !1)
              })
              .on('blur.mask', function () {
                i = o.val()
          ...
          getRegexMask: function () {
            for (var t, e, n, o, s = [], i = 0; i < a.length; i++)
              (t = r.translation[a.charAt(i)])
                ? ((e = t.pattern.toString().replace(/.{1}$|^.{1}/g, '')),
                  (n = t.optional),
                  (t = t.recursive)
                    ? (s.push(a.charAt(i)),
                      (o = { digit: a.charAt(i), pattern: e }))
                    : s.push(n || t ? e + '?' : e))
          ...
          calculateCaretPosition: function (t) {
            ...
            if (t !== a) {
              ...
              var r,
                ...
                c = 0,
                u = 0
              for (r = n; r < a && o.maskDigitPosMap[r]; r++) l++
              for (r = n - 1; 0 <= r && o.maskDigitPosMap[r]; r--) t++
              for (r = n - 1; 0 <= r; r--) o.maskDigitPosMap[r] && c++
              ...
              n > i
                ...
                ? o.maskDigitPosMapOld[n] ||
                  ((s = n),
                  (n = n - (u - c) - t),
                  o.maskDigitPosMap[n] && (n = s))
                : n > s && (n = n + (c - u) + l)
            }
            return n
          },
          behaviour: function (a) {
            ;(a = a || window.event), (o.invalid = [])
          ...
          getMasked: function (t, e) {
            ...
            for (; g(); ) {
              ...
              $
                ? (b.match($.pattern)
                    ...
                    ? ((c += f), (d -= f))
                    : $.fallback
                    ? (i[v]($.fallback), (c += f), (d -= f))
                    : o.invalid.push({ p: d, v: b, e: $.pattern }),
                  (d += f))
                : (t || i[v](y),
                  b === y
                    ? (e.push(d), (d += f))
            ...
            return (
              (t = a.charAt(k)),
              u !== p + 1 || r.translation[t] || i.push(t),
              (i = i.join('')),
              o.mapMaskdigitPositions(i, e, p),
              i
            )
          },
          mapMaskdigitPositions: function (t, e, a) {
            for (
              t = n.reverse ? t.length - a : 0, o.maskDigitPosMap = {}, a = 0;
              a < e.length;
              a++
            )
              o.maskDigitPosMap[e[a] + t] = 1
          },
          callbacks: function (t) {
            ...
            c('onChange', !0 === r, l),
              c('onKeyPress', !0 === r, l),
              c('onComplete', s.length === a.length, l),
              c('onInvalid', 0 < o.invalid.length, [s, t, e, o.invalid, n])
          },
        }
        e = t(e)
        var s,
          r = this,
          i = o.val()
        ;(a = 'function' == typeof a ? a(o.val(), void 0, e, n) : a),
          (r.mask = a),
          (r.options = n),
          (r.remove = function () {
            var t = o.getCaret()
          ...
          (r.init = function (i) {
            if (
              ...
              for (var l = !0; i < a.length; i++) {
                var c = r.translation[a.charAt(i)]
                if (c && c.recursive) {
                  l = !1
                  break
                }
      ...
      var a = function () {
          var a = t(this),
            ...
            s = a.attr('data-mask')
          if (
            (a.attr('data-mask-reverse') && (o.reverse = !0),
            a.attr('data-mask-clearifnotmatch') && (o.clearIfNotMatch = !0),
            'true' === a.attr('data-mask-selectonfocus') &&
              (o.selectOnFocus = !0),
            n(a, s, o))
          )
            return a.data('mask', new e(this, s, o))
        },
        n = function (e, a, n) {
          n = n || {}
          var o = t(e).data('mask'),
          ...
          try {
            return (
              ...
              'object' != typeof o || s(o.options) !== s(n) || o.mask !== a
            )
          } catch (t) {}
        },
        o = function (t) {
      ...
      ;(t.fn.mask = function (a, o) {
        ...
        var l = function () {
          if (n(this, a, o)) return t(this).data('mask', new e(this, a, o))
        }
        return (
          t(this).each(l),
          s &&
  ...
  $(function () {
    $('#phone').mask('+7(000)000-00-00', { clearIfNotMatch: !0 })
  }),
  $(document).ready(() => {
    let t = $('.form')
    t.submit(e => {
      let a = e.target.classList[0]
      $(`.${a} .button`).text('ЗАГРУЗКА...'),
        $(`.${a} .button`).attr('disabled', !0),
        e.preventDefault()
      let n = {}
      ;(n.name = $(`.${a} [name="name"]`).val()),
        (n.phone = $(`.${a} [name="phone"]`).val())
      let o = t.attr('action'),
        s = $(`.${a} [name="csrfmiddlewaretoken"]`).val()
      ;(n.csrfmiddlewaretoken = s),
        $.ajax({
          url: o,
          type: 'POST',
          data: n,
          ...
          success: t => {
            console.log('ok'),
              ...
              $(`.${a} [name="phone"]`).val(''),
              'ok' == t.result &&
                ($(`.${a} .button`).text('ОТПРАВИТЬ'),
                $(`.${a} .button`).attr('disabled', !1),
                alert('Заявка получена')),
              'error' == t.result &&
                ($(`.${a} .button`).text('ОТПРАВИТЬ'),
                $(`.${a} .button`).attr('disabled', !1),
                $(`.${a} [name="phone"]`).addClass('error'),
                console.log(t.response.phone))
          },
          error: () => {
            $(`.${a} .button`).text('ОТПРАВИТЬ'),
              $(`.${a} .button`).attr('disabled', !1),
  ...
  $('.slider').slick({
    ...
    autoplaySpeed: 5e3,
    prevArrow:
      '<button class="slider__slick-prev"><i class="fas fa-chevron-left"></i></button>',
    nextArrow:
      '<button class="slider__slick-next"><i class="fas fa-chevron-right"></i></button>',
  }),
  $('.lic__slider').slick({
    infinite: !0,
    speed: 500,
    ...
    prevArrow:
      '<button class="lic__slick-prev"><i class="fas fa-chevron-left"></i></button>',
    nextArrow:
      '<button class="lic__slick-next"><i class="fas fa-chevron-right"></i></button>',
  }),
  document.querySelectorAll('.about__button').forEach(t => {
    t.addEventListener('click', e => {
      e.preventDefault()
      const a = t.getAttribute('data-content')
      document.querySelectorAll('.about__content').forEach(t => {
        t.getAttribute('data-content') === a
          ? t.classList.remove('hidden')
          : t.classList.add('hidden')
      })
    })
  }),
  document.querySelector('.header__button').addEventListener('click', t => {
    t.preventDefault(),
      document.querySelector('.pop-up').classList.remove('hidden')
  }),
  document.querySelector('.pop-up__close').addEventListener('click', t => {
    t.preventDefault(),
